...
import { indicator_text_box_data, transport_mode_data } from '../components/GenericDashboardSetup/data/data';
...
const TransportMode = lazy(() => import('../components/GenericDashboardSetup/GenericChart'));
...
const Home = () => {
    ...
    return(
        ...
        <div className="socr--home" style={{backgroundColor:"white",overflowX:'hidden'}}>
            ...
            <TransportMode 
            indicator_ids= {[transport_mode_data,"indicator text box"]}
            minYear={2015}
            maxYear={2018}
