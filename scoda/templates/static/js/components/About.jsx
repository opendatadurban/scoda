...
export default class CTA_block extends Component {
    render() {
        return (
            <div className="about-us module-wrapper">
                <div className="container">
                    ...
                    <div className="row what-is-scoda mt-5 mb-5">
                        <div className="col-12">
                            <h3>What is SCODA?</h3>
                            <p>The <i>South African Cities Open Data Almanac</i> is a city-centric data portal that improves ease of access to current and comparable information about South African cities - informing evidence-based decision making and reporting.</p>
                        </div>
                    </div>
                    ...
                    <div className="row how-was-scoda-developed mt-5 mb-5">
                        <div className="col-12">
                            ...
                            <img src="/static/dist/img/SCODA Assets V3_1/3 About Us/How Was SCODA Developed/image_about_how-was-scoda-developed.svg" alt=""/>
                        </div>
                    </div>
                    ...
                    <div className="row important-links mt-5 mb-5">
                        <div className="col-12">
                            ...
                            <p>SCODA is a collaborative project by nature which utilises many inputs from multiple trusted sources to afford cities the opportunity to better understand themselves.  
Here are some of our core trusted sources:</p>
                        </div>
                        <div className="col item">
                            <img src="/static/dist/img/SCODA Assets V3_1/3 About Us/Important Links/logo_important-links_sacn.png" alt=""/>
                        </div>
                        <div className="col item">
                            <img src="/static/dist/img/SCODA Assets V3_1/3 About Us/Important Links/logo_important-links_2016-state-of-cities-report.png" alt=""/>
                        </div>
                        <div className="col item">
                            <img src="/static/dist/img/SCODA Assets V3_1/3 About Us/Important Links/logo_important-links_stepsa.png" alt=""/>
                        </div>
                        <div className="col item">
                            <img src="/static/dist/img/SCODA Assets V3_1/3 About Us/Important Links/logo_important-links_salga.png" alt=""/>
                        </div>
                        <div className="col item">
