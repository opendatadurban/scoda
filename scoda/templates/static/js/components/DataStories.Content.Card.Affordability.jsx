...
export default class DataStoriesContentCardAffordability extends Component {
    ...
    render() {
        ...
        let resources = `<o onClick="javascript:window.open('http://www.sacities.net/municipal-finance/','_new');">Read</o> more SACN publications and research on municipal finance matters on the SACN website
