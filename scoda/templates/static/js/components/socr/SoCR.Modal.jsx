                    ...
                    <div className="col-12 pr-0">
                        <div className="row">
                            ...
                            <div className="col report--content">
                                ...
                                <a href="https://www.sacities.net/wp-content/uploads/2022/04/SoCR-V-2021_WEB-144dpi.pdf" className="report--content--btn-download" download={true}>Download Report</a>
                            </div>
                        </div>
                        <div className="row">
                            ...
                            <div className="col report--content">
                                ...
                                <a href="https://www.sacities.net/wp-content/uploads/2020/09/SoCR16-Main-Report-online.pdf" className="report--content--btn-download" download={true}>Download Report</a>
                            </div>
                        </div>
                        <div className="row">
                            ...
                            <div className="col report--content">
                                ...
                                <a href="https://www.sacities.net/wp-content/uploads/2020/03/SACN-2011-Report.pdf" className="report--content--btn-download" download={true}>Download Report</a>
                            </div>
                        </div>
                        <div className="row">
                            ...
                            <div className="col report--content">
                                ...
                                <a href="https://www.sacities.net/wp-content/uploads/2020/03/state_of_cities_report2006.pdf" className="report--content--btn-download" download={true}>Download Report</a>
                            </div>
                        </div>
                        <div className="row">
                            ...
                            <div className="col report--content">
                                ...
                                <a href="https://www.sacities.net/wp-content/uploads/2020/03/SOCR_2004.pdf" className="report--content--btn-download" download={true}>Download Report</a>
                            </div>
                        </div>
                    </div>
                </div>
