...
def seed_db(db):
    ...
    with app.app_context():
        ...
        data = geojson.load(open('C:/Users/mrade_000/Documents/GitHub/scoda/scoda/data/JHB_Grid.json'))

        data2 = genfromtxt('C:/Users/mrade_000/Documents/GitHub/scoda/scoda/data/jhbgridmodel.csv', delimiter=',',
                           skip_header=1)
